...
// console.log("banana" == fruits[0][1]);
// fruits[2][0] = "apricot";
// console.log(fruits[2][0]);
//
// let newfruitsArray = ["blackberry", "lemon", "clementine"];
// fruits[5] = newfruitsArray;
// console.log(fruits[5]);
// console.log("lemon" == fruits[5][1]);
...
// for (let i = 0; i <= 4; i++) {
//   for (let j = 0; j <= 7; j++) {
//     //console.log("Prediction: Right now, i is 0 and j is 1.");
...
function findStringIn2DArray(arr, str) {
...
console.log(findStringIn2DArray(fruits, "apricot") == true);
console.log(findStringIn2DArray(fruits, "cake") == false);