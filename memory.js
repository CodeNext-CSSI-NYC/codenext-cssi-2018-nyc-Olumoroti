...
function play() {
  ...
  while (isGameOver(tracker) == false) {
    render(tracker);
    numGuesses++;
    let index1 = parseInt(readline.question("What card do you want to flip over: "));
    let index2 = parseInt(readline.question("What other card do you want to flip over: "));
  ...
  if (isGameOver(tracker) == true) {
    console.log("It took you " + numGuesses + " guesses to finish.");
  }
}
