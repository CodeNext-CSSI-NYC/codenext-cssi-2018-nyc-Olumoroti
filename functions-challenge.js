...
// let sam = sumDouble(2, 2);
// let dif = sumDouble(2, 3);
//
// console.log(sam);
// console.log(dif);
...
// let true1 = makes10(10, 2);
// let true2 = makes10(6, 4);
// let false1 = makes10(9, 9);
//
// console.log(true1, true2, false1);
...
function parrotTrouble(talking, hour) {
  if (talking == true && ((hour < 7 && hour >= 0) || (hour > 20 && hour <= 23))) {
    return true;

  } else if ((talking == true || talking == false) && (hour >= 0 || hour <= 23)){
    return false;
...
// let trouble = parrotTrouble(true, 5);
// let not = parrotTrouble(false, 5);
//
// console.log(trouble, not);
